...
<p align="center">
  <b>Getting Started with Create React Native App</b>
  <br />
...
- `npm ios` -- (`expo start --android`) Build the iOS App (requires a MacOS computer).
- `npm android` -- (`expo start --android`) Build the Android App.
- `npm web` -- (`expo start --android`) Run the website in your browser.
